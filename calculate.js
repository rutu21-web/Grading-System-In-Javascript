  ...
  function Grade(){
     ...
     if(sub1>100 || sub2>100 || sub3>100 || sub4>100 || sub5>100 )
    {
      alert("Please Enter Marks in range of 100");
       ...
       {
         document.getElementById("grade1").innerHTML="You Got B Grade";
       }
       else if(avg>=50 && avg<=60)
       {
         document.getElementById("grade1").innerHTML="You Got C Grade";
       }
       else if(avg>=40 && avg<=50)
       {
         ...
         document.getElementById("grade2").innerHTML="You Got F Grade";
       }
